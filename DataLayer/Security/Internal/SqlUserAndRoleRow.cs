...
ORDER BY UserName");
            ...
            return sqlUser 
                ? allUsers.Where(x => x.UserType[0] == SqlPermission.SqlUserChar) 
                : allUsers.Where(x => x.UserType[0] == SqlPermission.WindowsUserChar || x.UserType[0] == SqlPermission.WindowsGroupChar);
        }
    }
}
